...
class BookmarkHadithsDataRepository implements BookmarkHadithsRepository {
  ...
  Future<List<ChapterHadithEntity>> getBookmarkHadiths({required String tableName, required List<int> bookmarks}) async {
    final List<ChapterHadithModel> bookmarkHadiths = await localBookmarkHadiths.getBookmarkHadiths(tableName: tableName, bookmarks: bookmarks);
  ...
  // Mapping to entity
  ChapterHadithEntity _mapToHadithEntity(ChapterHadithModel hadith) {
