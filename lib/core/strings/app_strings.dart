class AppStrings {
  ...
  static const String favoriteIsEmpty = 'Список избранного пуст';
  ...
  static const String textsAlign = 'Расположение текста';

  static const String textColor = 'Цвет текста';

  static const String forLightTheme = 'Для дневной темы';
  static const String forDarkTheme = 'Для ночной темы';
  ...
  static const String moreOurApps = 'Больше наших приложений';
  static const String appStore = 'App Store';
  static const String googlePlay = 'Google Play';
  static const String ourSocials = 'Наши соцсети';
